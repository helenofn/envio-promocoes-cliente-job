package br.com.hfn.enviopromocoescliente.step;
...
public class EnvioEmailClientesStepConfig {
	...
	public Step enviaEmailClientesStep(
			ItemReader<InteresseProdutoCliente> lerInteressesProdutoClienteReader,
			ItemProcessor<InteresseProdutoCliente, SimpleMailMessage> processarEmailProdudoClienteProcessor,
		...
		return stepBuilderFactory
				...
				.reader(lerInteressesProdutoClienteReader)
				.processor(processarEmailProdudoClienteProcessor)
